...
*Server* 
*   ~/workspace/ul_autotest/ directory has scheduler.c (compiled), setup.sh, rx_report.sh, and config.csv  

*Client*
*   ~/workspace/ul_autotest/ directory has iperf3_daemon (compiled), fixed_rate.sh
